...
//     echo "
//         <script>
//         alert('Orderan masih kosong, belanja dulu yu!');
//         location='index.php';
//         </script>
//     ";
// }
...
<body>
    ...
    <div class="container">
        <h2 style="text-align: center; margin-top: 20px;">History Order <?= $nameUser; ?></h2>
        <?php
        ...
        ?>
            ...
            <?php elseif ($order["status"] === "accept") : ?>
                ...
                <h2 style="text-align: center; margin-top: 20px ; color: green;">Terima Kasih sudah membeli produk dari kami, semoga suka yaa!</h2>
            <?php else : ?>
